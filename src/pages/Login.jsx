  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.message?.includes("Database not connected")) {
        setError("ডাটাবেস সংযোগ স্থাপন করা যায়নি। দয়া করে MongoDB চালু করুন।");
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-center justify-center p-4">
      <div className="max-w-sm w-full bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-extrabold text-gray-900">এডমিন প্যানেল</h1>
          <p className="text-gray-500 text-xs mt-1">Vision E-commerce - আপনার অ্যাকাউন্টে লগইন করুন</p>
        </div>

        {/* Login Form */}
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-bold text-gray-700 mb-1.5">ইউজারনেম / ইমেইল</label>
            <div className="relative">
              ...
              <input
                ...
                placeholder="superadmin বা superadmin@gmail.com"
                required
              />
            </div>
          </div>
          ...
          <div>
            <label className="block text-xs font-bold text-gray-700 mb-1.5">পাসওয়ার্ড</label>
            <div className="relative">
              <input
        ...
        <div className="mt-6 pt-4 border-t border-gray-100">
          <p className="text-xs text-gray-400 text-center">ডিফল্ট ক্রেডেনশিয়াল: superadmin / admin123</p>
        </div>
      </div>
    </div>
  );
