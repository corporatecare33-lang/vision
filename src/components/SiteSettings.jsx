...
const SiteSettings = () => {
  ...
  const fields = [
    { key: "siteName", label: "সাইটের নাম", type: "text" },
    { key: "siteUrl", label: "সাইটের URL", type: "text" },
  ...
  const seoFields = [
    ...
    { key: "seoKeywords", label: "SEO Keywords (কমা দিয়ে)", type: "text" },
  ];
    ...
    <div className="space-y-6 animate-fadeIn">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <button onClick={handleSave} disabled={saving}
          ...
          {saving ? <><RefreshCcw className="w-4 h-4 animate-spin" /> সেভ হচ্ছে...</> : <><Save className="w-4 h-4" /> সেভ করুন</>}
        </button>
      </div>

      <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-6">
        <div>
          <h4 className="text-sm font-bold text-gray-900 mb-4">সাধারণ তথ্য</h4>
        ...
        <div>
          <h4 className="text-sm font-bold text-gray-900 mb-4">ঠিকানা ও ফুটার</h4>
          <div className="space-y-4">
            ...
            <div>
              <label className="text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-2 block">ফুটার টেক্সট</label>
        ...
        <div>
          <h4 className="text-sm font-bold text-gray-900 mb-4">লোগো ও ফেভিকন</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
            ...
            <div>
              <label className="text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-2 block">ফেভিকন URL</label>
        ...
        <div>
          <h4 className="text-sm font-bold text-gray-900 mb-4">সোশ্যাল লিংক</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {socialFields.map(f => (
              <div key={f.key}>
                <label className="text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-2 block">{f.label}</label>
        ...
        <div>
          <h4 className="text-sm font-bold text-gray-900 mb-4">SEO সেটিংস</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {seoFields.map(f => (
